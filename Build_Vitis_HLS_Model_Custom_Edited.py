...
model = keras.Sequential([
    ...
    custom.KCustomDSPDense(8, activation = None, name = "dense1"),
    keras.layers.ReLU(name = "relu1"),
    custom.KCustomDSPDense(8, activation = None, name = "dense2"),
    keras.layers.ReLU(name = "relu2"),
    custom.KCustomDSPDense(8, activation = None, name = "dense3"),
