...
typedef ap_int<16> layer5_t;
typedef ap_int<48> relu2_param_t;
typedef ap_fixed<18,8> relu2_table_t;
typedef ap_int<48> dense3_accum_t;
typedef ap_int<48> layer6_t;
typedef ap_int<16> dense3_weight_t;
typedef ap_int<16> dense3_bias_t;
typedef ap_uint<1> layer6_index;
typedef ap_int<16> result_t;
typedef ap_int<48> relu3_param_t;
